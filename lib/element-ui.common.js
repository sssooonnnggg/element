	...
	exports.default = {
	  ...
	  created: function created() {
	    ...
	    this.drake.on('drop', function (el, target, source, sibling) {
	      ...
	      if (!sibling) {
	        _this.$emit('insert-after', nodeId);
	      } else {
	        _this.$emit('insert-before', nodeId);
	      }
	    });
	    ...
	    this.drake.on('shadow', function (el, dropTarget, _source) {
	      ...
	      if (!parentNode) {
	        ...
	        var node = _this.store.getNode(parentNode.id);
	        indent = node.indent;
	      }

	      var fixedPadding = _this.indent * indent;
	      ...
	      var addPadding = function addPadding(item) {
	        ...
	        for (var _iterator = item.children, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
	          var _ref;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(242)("4da8dd48", content, true, {});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  beforeDestroy: function beforeDestroy() {
	    ...
	    var tree = this.tree;
	    var containers = tree.drake.containers;
	    var index = containers.find(function (conatainer) {
	      return conatainer == _this.$refs.content;
	    });
