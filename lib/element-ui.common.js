...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    hideNode: function hideNode(nodeId, hidden) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Node = function () {
	    ...
	    if (!this.store.lazy || this.store.lazy === true && this.loaded === true) {
	      var _ret = function () {
	        var isDescendantHidden = function isDescendantHidden(data) {
	          ...
	          for (var _iterator = data.childNodes, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
	            var _ref;
	  ...
	  Node.prototype.updateChildren = function updateChildren() {
	    ...
	    newNodes.forEach(function (_ref2) {
...
/***/ function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  })], 1) : _vm._e(), (_vm.expanded || _vm.node.hiddenSelf) ? _c('div', {
