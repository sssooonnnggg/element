...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _dragula = __webpack_require__(237);

	var _dragula2 = _interopRequireDefault(_dragula);

	var _dragulaInstance = __webpack_require__(238);

	var _dragulaInstance2 = _interopRequireDefault(_dragulaInstance);
	...
	exports.default = (_name$mixins$componen = {
	  ...
	  methods: {
	    ...
	    hideNode: function hideNode(id, hidden) {
	    ...
	    shouldShowShadowItemImpl: function shouldShowShadowItemImpl(node) {
	      if (!this.draggable) {
	        return false;
	      }
	  ...
	  if (this.draggable) {
	    this.drake = _dragulaInstance2.default;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DragulaWrapper = function () {
	  function DragulaWrapper() {
	    var _this = this;

	    _classCallCheck(this, DragulaWrapper);

	    this.drake = (0, _dragula2.default)({
	      copy: true,
	      accepts: function accepts(el, target, source, sibling) {
	        ...
	        var nodeId = target.children[0].id;
	        var targetNode = _this.tree.store.getNode(nodeId);
	        var node = _this.tree.store.getNode(el.id);
	        if (!targetNode) {
	          return false;
	        }
	        return _this.tree.isDropValidImpl(node, targetNode);
	      },
	      isContainer: function isContainer(el) {
	        return _this.tree && _this.tree.$el.contains(el) && _this.tree.draggable && el.className == "drag-content";
	      },
	      invalid: function invalid(el, handle) {
	        ...
	        if (!_this.tree.$el.contains(el)) {
	          return true;
	        }

	        var node = _this.tree.store.getNode(getNodeId(el));

	        if (!node) {
	          return true;
	        }

	        return !_this.tree.isDragValidImpl(node);
	      }
	    });

	    this.drake.on("drop", function (el, target, source, sibling) {
	      if (!target || !_this.tree) {
	        return;
	      }

	      var nodeId = target.children[0].id;
	      var siblingNode = _this.tree.store.getNode(nodeId);
	      var node = _this.tree.store.getNode(el.id);

	      if (!sibling) {
	        _this.tree.$emit("node-insert-after", node.data, siblingNode.data);
	      } else {
	        _this.tree.$emit("node-insert-before", node.data, siblingNode.data);
	      }
	    });

	    // 拖放时虚节点的缩进处理一级是否显示
	    this.drake.on("shadow", function (el, dropTarget, _source, sibling) {

	      if (!_this.tree) {
	        return;
	      }

	      if (sibling && !_this.tree.shouldShowShadowItemImpl(_this.tree.store.getNode(sibling.id))) {
	      ...
	      var findParent = function findParent(item) {
	        ...
	        if (!parentNode) {
	          ...
	          if (parentNode.className && parentNode.className.match(/el-tree-node$|el-tree-node\s/g)) {
	            return parentNode;
	          }
	      ...
	      var parentNode = findParent(dropTarget);
	      var indent = void 0;
	      if (!parentNode) {
	        indent = 0;
	      } else {
	        var node = _this.tree.store.getNode(parentNode.id);
	        indent = node.indent;
	      }

	      var fixedPadding = _this.tree.indent * indent;
	      var actualPadding = parseInt(el.children[0].style.paddingLeft);
	      var extraPadding = fixedPadding - actualPadding;
	      var addPadding = function addPadding(item) {
	        if (item.className.match(/el-tree-node__content$|el-tree-node__content\s/g)) {
	          var originPadding = parseInt(item.style.paddingLeft);
	  ...
	  DragulaWrapper.prototype.addEventListener = function addEventListener(tree) {
	    this.tree = tree;
	  };

	  DragulaWrapper.prototype.removeEventListener = function removeEventListener() {
	    this.tree = null;
	  };

	  return DragulaWrapper;
	}();

	var dragulaInstance = new DragulaWrapper();

	exports.default = dragulaInstance;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(243)("4da8dd48", content, true, {});
...
/***/ (function(module, exports) {
	...
	module.exports = require("dragula/dist/dragula.css");
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [(!_vm.node.nodeShouldHidden) ? _c('div', {
	    directives: [{
	      name: "show",
	      rawName: "v-show",
