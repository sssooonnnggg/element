...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    updataPosition: function updataPosition() {
	      this.t = this.top || 200;
	      this.l = this.left || -1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (_name$mixins$componen = {
	  ...
	  methods: {
	    ...
	    sortChildren: function sortChildren(data, cmp) {
	      var node = this.store.getNode(data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Node = function () {
	  ...
	  Node.prototype.sortChildren = function sortChildren(cmp) {
	    if (this.childNodes) {
	      this.childNodes.sort(function (node1, node2) {
